...
function MedievalCastlesLayoutInner({ children }: { children: ReactNode }) {
...
export default function MedievalCastlesLayout({ children }: { children: ReactNode }) {
  return (
    <LanguageProvider>
      <MedievalCastlesLayoutInner>{children}</MedievalCastlesLayoutInner>
    </LanguageProvider>
  )
}
